...
<h3>Sửa tài khoản</h3>
<form:form action="${contextPage}/admin/account/edit" method="post" enctype="multipart/form-data" modelAttribute="account">
	<table class="table">
		<tr>
			<td>Mã tài khoản</td>
			<td><form:input path="id" /><span>${account.id}</span></td>
		...
		<tr>
			<td>Ảnh</td>
			<td><img alt="" src="${contextPage}/${account.img}"></td>
